...
public class Draw1dBarcodeActivity extends Activity implements View.OnClickListener, DialogInterface.OnClickListener {
	...
	private void print1dBarcode() {
		...
		BixolonPrinterPlugin.mBixolonLabelPrinter.setLength(1218, 24, BixolonLabelPrinter.MEDIA_TYPE_GAP, 0);
		BixolonPrinterPlugin.mBixolonLabelPrinter.draw1dBarcode(data, horizontalPosition, verticalPosition, mBarcodeSelection,
