...
public class DrawQrCodeActivity extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		if (radioButtonId == R.id.radio6) {
			rotation = BixolonLabelPrinter.ROTATION_NONE;
		} else if (radioButtonId == R.id.radio7) {
		...
		BixolonPrinterPlugin.mBixolonLabelPrinter.drawQrCode(data, horizontalPosition, verticalPosition, model, eccLevel, size, rotation);
