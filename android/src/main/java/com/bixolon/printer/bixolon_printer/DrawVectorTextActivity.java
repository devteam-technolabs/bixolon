...
public class DrawVectorTextActivity extends Activity implements View.OnClickListener, DialogInterface.OnClickListener {
	...
	private void printLabel() {
		...
		} else if (radioButtonId == R.id.radio5) {
			alignment = BixolonLabelPrinter.VECTOR_FONT_TEXT_ALIGNMENT_RIGHT;
		} else if (radioButtonId == R.id.radio6) {
		...
		BixolonPrinterPlugin.mBixolonLabelPrinter.drawVectorFontText(data, horizontalPosition, verticalPosition, mFont, width, height, rightSpace,
